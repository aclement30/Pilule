...
<?php if ( !empty( $user ) ): ?>
    ...
    <div id="user-nav" class="navbar">
        ...
        <ul class="nav btn-group external-frame">
            <li><a title="Revenir au site de Pilule" href="javascript:app.Common.closeExternalFrame();"><i class="icon icon-arrow-left"></i> <span class="text">Revenir à Pilule</span></a></li>
        </ul>
    </div>
