<div class="<?php if ( isset( $modal )) echo 'well'; ?>" style="margin-bottom: 0px;">
	...
	<p>Les cours complétés sont affichés en noir et les cours disponibles à l'inscription sont affichés en vert.</p>
	<p style="margin-bottom: 0px;">Vous pouvez consulter les informations du cours en cliquant sur la ligne correspondante.</p>
</div>