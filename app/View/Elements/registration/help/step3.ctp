<div class="<?php if ( isset( $modal ) ) echo 'well'; ?>" style="margin-bottom: 0px;">
	...
	<p>Si le bouton Inscription n'apparaît pas, il est possible que la période d'inscription ne soit pas encore commencée ou déjà terminée. Vous pouvez toutefois déjà faire votre sélection qui sera gardée en mémoire.</p>
	<p style="margin-bottom: 0px;">Pour enlever un cours de votre sélection, cliquez sur celui-ci, puis cliquez sur le bouton <strong>Enlever</strong> qui apparaît.</p>
</div>