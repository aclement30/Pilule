<div class="<?php if ( isset( $modal ) ) echo 'well'; ?>" style="margin-bottom: 0px;">
	...
	<p style="margin-bottom: 0px;">Pour vous inscrire à un cours, cliquer d'abord sur le bouton <strong>Ajouter</strong> correspondant. Le cours choisi sera alors automatiquement ajouté à votre sélection de cours dans la colonne de gauche.</p>
</div>