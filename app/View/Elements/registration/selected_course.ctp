<tr data-nrc="<?php echo $course[ 'nrc' ]; ?>" data-credits="<?php echo $course[ 'credits' ]; ?>" data-title="<?php echo $course[ 'code' ]; ?> <button class='btn btn-mini btn-danger remove-course' data-nrc='<?php echo $course[ 'nrc' ]; ?>'>Enlever</button><img src='/img/loading-btn.gif' class='loading-img' />" data-content="<?php echo $course[ 'title' ]; ?>" data-trigger="manual" data-html="true" data-placement="top">
	<td>
