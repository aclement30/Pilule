 ...
 * http.php
 *
 * @(#) $Header: /opt2/ena/metal/http/http.php,v 1.84 2011/07/31 03:38:51 mlemos Exp $
 *
 */
...
class HttpFetcher
{
	...
	var $user_agent="Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; fr; rv:1.9.1.6) Gecko/20091201 Firefox/3.5.6";
	var $accept='';
	...
	Function SendRequest($arguments)
	{
		...
		|| $this->request_method=="PUT")
		{
			...
			elseif(IsSet($arguments["PostString"]))
			{
				$this->request_body = $arguments['PostString'];
				$this->request_headers["Content-Type"]="application/x-www-form-urlencoded".(IsSet($arguments["CharSet"]) ? "; charset=".$arguments["CharSet"] : "");
				$get_body=0;
			}
		}
