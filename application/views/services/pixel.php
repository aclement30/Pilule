...
<div style="margin-bottom: 20px; margin-top: 10px;"><img src="./images/redirect-loading.gif" alt="Chargement" /></div><strong>Redirection vers Pixel...</strong></div>
<form id="login-form" action="https://pixel.fsg.ulaval.ca/index.pl" method="post">
<input type="hidden" name="envoi" value="Se connecter">
<input type="hidden" name="code_utilisateur" value="<?php echo $user['idul']; ?>">
