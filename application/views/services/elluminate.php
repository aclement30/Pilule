...
<title>Connexion à Elluminate</title>
...
<div style="margin-bottom: 20px; margin-top: 10px;"><img src="./images/redirect-loading.gif" alt="Chargement" /></div><strong>Redirection vers Elluminate...</strong></div>
<form id="login-form" action="https://classevirtuelle.ulaval.ca/elm_login.event?loginPage=index.html" method="post">
