...
if ($_ENV["HOME"] == '/Users/aclement') {
	if (file_exists('../.webdesk_local_sharing')) {
		...
		$config['base_url']	= 'http://localhost:8888/Pilule/';
	}
} else {
	$config['base_url']	= 'https://www.pilule.ulaval.ca/';
}
*/
//$config['base_url'] = 'http://192.168.0.100/Pilule/';
...
|
*/
$config['encryption_key'] = '?!&#!@(?#&H#!@?&*#H!@&#*!@G?BGDAJBFSFD?!?%#%!&HG1yt2632512bFI?&12SF%b2fs5mhqs5f23sb!8-nh|IM';
