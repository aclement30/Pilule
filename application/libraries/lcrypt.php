...
class lCrypt {
    ...
    protected function SetMode($mode) {
        lCrypt::IsSupportedMode($mode) && $this->mode = (int)$mode;
    }
    ...
    protected function SetHash($hash) {
        lCrypt::IsSupportedHash($hash) && $this->hash = (int)$hash;
    }
    ...
    public static function IsSupportedMode($mode) { 
        return in_array($mode, lCrypt::SupportedModes());
    }
    ...
    public static function IsSupportedHash($hash) { 
        return in_array($hash, lCrypt::SupportedHashes());
    }
   ...
   public function Decrypt($crypt) {
    ...
    public function Hash($data, $binary = false) {
        $crypt = new lCrypt(CRYPT_MODE_BINARY);
        $crypt->Key = $this->key;
